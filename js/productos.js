...
document.addEventListener('DOMContentLoaded', function () {
        ...
        let productos = [
            {
                ...
                imagen: '../image/fender-telecaster-natural.jpg',
            ...
            },
            {
                ...
                imagen: '../image/gibson-les-paul.jpg',
                descripcion: 'Color madera',
                categoria: 'gibson'
            },
            {
                id: 2,
                nombre: 'gibson Sg',
                imagen: '../image/gibson-special-sg-worn-brown.jpg',
    ...
    if (sessionStorage.getItem('loginForm')) {
        let userString = sessionStorage.getItem('loginForm');
        ...
        navNombre.innerHTML = '<h6 class="m-2">'+userDatos.nombre+'</h6><button class="" id="salirBtn">Exit</button>';
        //Salir
